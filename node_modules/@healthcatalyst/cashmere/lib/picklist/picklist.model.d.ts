 ...
 * @ignore
 */
export declare type PicklistValueType = 'values' | 'valuesets' | 'both';
 ...
 * @ignore
 */
export declare class PicklistOptionsSource implements IPicklistOptionsSource {
    values: IValueOption[];
    valueSets: IValueSetOption[];
    isPaged: boolean;
    pageSize: number;
    getOptions?: (params: PicklistRemoteQueryOptions) => Observable<IPicklistRemoteQueryResponse>;
    getValuesForValueset?: (code: string) => Observable<IValueOption[]>;
    optionsAreLocal(): boolean;
}
/**
 * @ignore
 */
export declare class PicklistSettings implements IPicklistSettings {
    codeIsSignificant: boolean;
    useValuesets: boolean;
    showHeaderText: boolean;
    leftHeaderText: string;
...
export declare class PicklistRemoteQueryOptions {
