 ...
 * column definition.
 */
export declare class HcSortHeader implements HcSortable, OnDestroy, OnInit {
    _intl: HcSortHeaderIntl;
    _sort: HcSort;
    ...
    _hostClass: boolean;
    private _disabled;
    constructor(_intl: HcSortHeaderIntl, changeDetectorRef: ChangeDetectorRef, _sort: HcSort, _cdkColumnDef: CdkColumnDef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    /**
