...
import { D, HcDateFormats } from '../datetime/date-formats';
import { DateAdapter } from '../datetime/date-adapter';
/**
 * An internal component used to display a single month in the datepicker.
 * @docs-private
 */
export declare class MonthViewComponent implements AfterContentInit {
    ...
    constructor(_changeDetectorRef: ChangeDetectorRef, _dateFormats: HcDateFormats, _dateAdapter: DateAdapter<D>, _dir?: Directionality | undefined);
