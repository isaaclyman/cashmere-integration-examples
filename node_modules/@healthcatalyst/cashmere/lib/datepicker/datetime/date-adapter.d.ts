...
export declare const HC_DATE_LOCALE: InjectionToken<string>;
/** @docs-private */
export declare function HC_DATE_LOCALE_FACTORY(): string;
/**
 ...
 */
export declare const HC_DATE_LOCALE_PROVIDER: {
