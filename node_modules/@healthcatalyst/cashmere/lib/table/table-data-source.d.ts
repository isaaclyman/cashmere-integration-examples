...
import { HcSort } from '../sort/index';
import { LoadMorePaginationComponent } from '../pagination/index';
import { BasePaginationComponent } from '../pagination/base-pagination';
/**
 * Use to see what kind of pager we have
 */
export declare function _isLoadMorePaginator(pager: BasePaginationComponent): pager is LoadMorePaginationComponent;
/**
 ...
 */
export declare class HcTableDataSource<T> extends DataSource<T> {
     ...
     */
    paginator: BasePaginationComponent | null;
    private _paginator;
    /**
