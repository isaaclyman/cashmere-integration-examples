...
/** @type {?} */
export var APP_SWITCHER_SERVICE = new InjectionToken('IAppSwitcherService');
/**
 * @record
 */
...
/** @type {?} */
export var APP_SWITCHER_CONFIG = new InjectionToken('IAppSwitcherConfig');
var MockAppSwitcherService = /** @class */ (function () {
    function MockAppSwitcherService() {
    }
    /**
     * @return {?}
     */
    MockAppSwitcherService.prototype.getApplications = /**
     * @return {?}
     */
    function () {
        return of({
