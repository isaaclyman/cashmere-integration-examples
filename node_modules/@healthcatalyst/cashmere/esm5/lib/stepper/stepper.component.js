 ...
 * @return {?}
 */
export function throwErrorForMissingRouterLink(stepsWithoutRouterLink) {
    /** @type {?} */
    var stepLabels = stepsWithoutRouterLink.map((/**
     * @param {?} step
     * @return {?}
     */
    function (step) { return step.label; }));
...
var StepperComponent = /** @class */ (function () {
    function StepperComponent(router, urlSerializer) {
        var _this = this;
        this.router = router;
        ...
        function (event) {
            if (event instanceof NavigationEnd) {
                _this.findCurrentStep();
            }
        }));
    }
    Object.defineProperty(StepperComponent.prototype, "color", {
    ...
    Object.defineProperty(StepperComponent.prototype, "showStepCount", {
    ...
    Object.defineProperty(StepperComponent.prototype, "useRouterOutlet", {
    ...
    Object.defineProperty(StepperComponent.prototype, "activeIndex", {
     ...
     * @return {?}
     */
    StepperComponent.prototype._stepClick = /**
     * @param {?} index
     * @return {?}
     */
    function (index) {
     ...
     * @return {?}
     */
    StepperComponent.prototype._checkForRouterUse = /**
     * @private
     * @return {?}
     */
    function () {
        /** @type {?} */
        var countUsingRouter = this.steps.filter((/**
         * @param {?} step
         * @return {?}
         */
        function (step) { return step.routerLink !== undefined; })).length;
        if (countUsingRouter > 0 && countUsingRouter < this.steps.length) {
            /** @type {?} */
            var stepMissingRouterLink = this.steps.filter((/**
             * @param {?} step
             * @return {?}
             */
            function (step) { return step.routerLink === undefined; }));
     ...
     * @return {?}
     */
    StepperComponent.prototype.findCurrentStep = /**
     * Can be used to activate the current step following \@Input() steps routerLink or queryParams updates
     * @return {?}
     */
    function () {
        var _this = this;
        /** @type {?} */
        var foundActiveRouteIndex = this.steps.findIndex((/**
         * @param {?} step
         * @return {?}
         */
        function (step) {
            /** @type {?} */
            var urlTree = _this.router.createUrlTree([step.routerLink], { queryParams: step.queryParams });
            /** @type {?} */
            var stepURL = _this.urlSerializer.serialize(urlTree);
            return _this.router.isActive(stepURL, true);
        }));
...
//# sourceMappingURL=data:application/json;base64,